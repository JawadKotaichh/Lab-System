...
const SearchTest : React.FC<SearchForATest> = ({searchInput,allTests,setSearchInput,setVisibleTests}:SearchForATest) =>{
    function handleSearch(e:React.ChangeEvent<HTMLInputElement>){
            ...
            const filtered_tests = allTests.filter(t => t.lab_test_name.toLowerCase().includes(test.toLowerCase()));
